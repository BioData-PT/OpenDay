...
Biome-Shiny uses a format called .biom for inputs, but it also has a set of test data.
...
"Dietswap" is a large dataset. It has many different microbes and many samples. Biome-Shiny can help filter out the data.
...
2. Tick "Set as active dataset" when you're done. Biome-Shiny will automatically update the dataset with any changes.
...
Biome-Shiny allows the user to save plots and tables with ease. Plots will be saved in a .csv file format, which will allow 
